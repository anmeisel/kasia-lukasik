...
var path = '/assets/cursor.gif' // URL of your image
...
function initTrail() {
  ...
  for (i = 0; i < images.length; i++) {
    ...
    document.write(
      '<div id="obj' +
        i +
        '" style="position: absolute; top: 0px; z-Index: 100; height: 0; width: 0;filter: invert(1); fill: black;"><img src="' +
        images[i].src +
        '"></div>'
    )
  }
...
function trail() {
  ...
  var timer = setTimeout('trail()', 50) // call recursively
}
